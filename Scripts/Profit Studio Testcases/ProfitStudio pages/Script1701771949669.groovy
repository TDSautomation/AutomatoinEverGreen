...
WebUI.rightClick(findTestObject('Object Repository/Page_Profit Studio - Top Sellers (JVZoo)/h1_Top Sellers (JVZoo)'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Profit Studio - Top Sellers (JVZoo)/h1_Top Sellers (JVZoo)'), 
    'Top Sellers (JVZoo)')

WebUI.click(findTestObject('Object Repository/Page_Profit Studio - Top Sellers (JVZoo)/img'))
